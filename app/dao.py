...
from app.models import (ApplicationStatus, Category, Chapter, Comment, Course,
                        CourseCategory, CourseOutcome, DocContent, Enrollment,
                        EnrollmentStatus, Lesson, LessonProgress, LessonType,
                        Payment, PaymentStatus, Post, PostCate, ReactionComment,
                        ReactionPost, Teacher, TeacherApplication, User,
                        VideoContent, Conversation, ConversationMember, Message,
                        MessageReaction, )
...
def react_message(message_id,user_id,emoji,):
    reaction = MessageReaction.query.filter_by(message_id=message_id,user_id=user_id,).first()
